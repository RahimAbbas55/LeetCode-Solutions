/*
    ...
    you start with an empty record.You are given a list of strings operations, where operations[i] is 
...
var calPoints = function(operations) {
    ...
    for ( let i = 0 ; i < operations.length ; i++ ){
        ...
        // remove case
        else if ( operations[i] === 'C' || operations[i] === 'c' ){
            record.pop();
        }
        // push integer to record
        else{
            record.push(parseInt(operations[i]));
        }
        // console.log(`at ${i}` , record)
    }
